...
import { Card, Table, Space, Button, message, Tag, Empty, DatePicker, InputNumber, Row, Col, Form, Spin } from 'antd';
import { ArrowLeftOutlined, ReloadOutlined, LoadingOutlined, FilterOutlined, HomeOutlined } from '@ant-design/icons';
...
const Detail = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 150,
      render: (value) => (
        <Tag color={getStatusColor(value, 'temperature')} className="detail-tag">
          {value}°C
        </Tag>
      ),
    ...
    },
    {
      ...
      width: 150,
      render: (value) => (
        <Tag color={getStatusColor(value, 'humidity')} className="detail-tag">
          {value}%
        </Tag>
      ),
    ...
    },
    {
      ...
      width: 150,
      render: (value) => (
        <Tag color={getStatusColor(value, 'light')} className="detail-tag">
          {value} lux
        </Tag>
      ),
    ...
    },
    {
      ...
      width: 150,
      render: (value) => (
        <Tag color={getStatusColor(value, 'gas')} className="detail-tag">
          {value} ppm
        </Tag>
      ),
  ...
  if (data.length === 0 && !loading) {
    return (
      <div className="detail-bg-gradient detail-empty-wrapper">
  ...
  return (
    <div className="detail-bg-gradient">
      <div className="detail-center-wrapper">
        <Card
          ...
          title={
            <Space>
              ...
              <span className="detail-title"><HomeOutlined /> Living Room Detailed Data</span>
            </Space>
          }
          extra={
            <Space>
            ...
            >
              <Row gutter={[16, 16]}>
                <Col xs={24} sm={12} md={6}>
                  <Card className="detail-filter-card">
              ...
              <Row justify="end" className="detail-filter-btn-row">
                <Space>
                  <Button onClick={resetFilters} className="detail-reset-btn">Reset Filters</Button>
                  <Button 
                    type="primary" 
                    icon={<FilterOutlined />} 
