...
const Bedroom2 = () => {
  ...
  const getSensorAdvice = (sensor, value) => {
    ...
    if (sensor === 'light') {
      const standard = LIGHT_STANDARDS.BEDROOM_2;
    ...
    const thresholds = SENSOR_THRESHOLDS.BEDROOM_2?.[sensor];
  ...
  const renderSensorValue = (sensor, value) => {
    ...
    const thresholds = sensor === 'light' 
      ? LIGHT_STANDARDS.BEDROOM_2 
      : SENSOR_THRESHOLDS.BEDROOM_2?.[sensor];
